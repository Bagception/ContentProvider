...
public class AddNewBagActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_add_new_bag);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.add_new_bag, menu);
		return true;
	}
	...
	public void handleListViewDiscoveredDevicesClick(BluetoothDevice device) {
		...
		if (arrayAdapterDiscoveredDevices.getCount() > 0) {
			listviewDiscoveredDevices.setClickable(true);
			ManageConnection mg = new ManageConnection(
					AddNewBagActivity.this);
			mg.execute(device);
		} else {
	...
	final BroadcastReceiver mReceiver = new BroadcastReceiver() {
		...
		public synchronized void onReceive(Context context, Intent intent) {
			...
			if (BluetoothDevice.ACTION_FOUND.equals(action)) {
				...
				dialog = ProgressDialog.show(AddNewBagActivity.this,
						"scanning..",
